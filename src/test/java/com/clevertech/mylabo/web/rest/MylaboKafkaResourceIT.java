...
import com.clevertech.mylabo.MylaboApp;
...
@SpringBootTest(classes = MylaboApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class MylaboKafkaResourceIT {
    ...
    @Autowired
    private MylaboKafkaProducer producer;

    @Autowired
    private MylaboKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        MylaboKafkaResource kafkaResource = new MylaboKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/mylabo-kafka/publish?message=test"))
